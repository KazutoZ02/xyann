...
MODEL_REGISTRY = {
    ...
    # Frontend Models
    "North Mini Code": {"provider": "openrouter", "id": "cohere/north-mini-code:free", "category": "Frontend Models"},
    ...
    # Backend Models
    "Laguna S 2.1": {"provider": "nara", "id": "laguna-s-2.1", "category": "Backend Models"},
    "Laguna M.1": {"provider": "openrouter", "id": "poolside/laguna-m.1:free", "category": "Backend Models"},
    "Laguna XS 2.1": {"provider": "openrouter", "id": "poolside/laguna-xs-2.1:free", "category": "Backend Models"},
    "GPT-OSS 20B": {"provider": "openrouter", "id": "openai/gpt-oss-20b:free", "category": "Backend Models"},
    
    # Full Stack Models
    "Nemotron 3 Ultra": {"provider": "nara", "id": "nemotron-3-ultra", "category": "Full Stack Models"},
    "Nemotron 3 Super": {"provider": "openrouter", "id": "nvidia/nemotron-3-super-120b-a12b:free", "category": "Full Stack Models"},
    ...
    "Grok 4.5": {"provider": "nara", "id": "grok-4.5", "category": "Full Stack Models"},
    
    # Image Models
    "Nemotron Nano 12B VL": {"provider": "openrouter", "id": "nvidia/nemotron-nano-12b-v2-vl:free", "category": "Image Models"},
    "Nemotron 3 Nano Omni": {"provider": "openrouter", "id": "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free", "category": "Image Models"},
